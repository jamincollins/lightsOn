...
# "./lightsOn.sh 120 &" will Check every 120 seconds if Mplayer, Minitube VLC,
# Firefox or Chromium are fullscreen and delay screensaver and Power Management
# if so.
...
# maintain a view of the program from a distance, like a music playlist for
# DJing, or if the screensaver eats up CPU that chops into any background
# processes you have running, such as realtime music programs like Ardour in
# MIDI keyboard mode.
